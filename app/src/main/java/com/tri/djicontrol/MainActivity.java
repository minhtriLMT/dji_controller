...
public class MainActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener {
    ...
    private Button btnStart, btnCancel, btnToggleMenu, btnCaptureManual, btnFormatSd, btnToggleCameraMode, btnViewPhotos;
            ...
            if (isCurrentModePhoto) {
                camera.startShootPhoto(djiError -> {
                    if (djiError == null) {
                        ...
                        runOnUiThread(() -> Toast.makeText(MainActivity.this, "Lỗi chụp: " + djiError.getDescription(), Toast.LENGTH_SHORT).show());
                    }
                });
            } else {
                if (!isRecordingVideo) {
